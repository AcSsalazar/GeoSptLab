"""
Automated API Testing Script for CP-00633 Casa Las Palmas Project (v0.2.0)
===========================================================================

This script tests the complete backend API workflow using realistic geotechnical data
from the Excel project. It follows the new data structure with StratumDefinition + BoreholeStratum.

NEW STRUCTURE (v0.2.0):
- StratumDefinition: Material properties only (no depths)
- BoreholeStratum: Links boreholes to strata with specific depths
- SPTInterval: References BoreholeStratum instead of global strata
...
class APITester:
    """Automated API testing class for the SPT calculation backend (v0.2.0)."""
    ...
    def run_complete_test(self) -> bool:
        ...
        self.log("🚀 Starting Complete API Test Workflow (v0.2.0)")
        self.log("=" * 55)
...
def main():
    ...
    print("CP-00633 Casa Las Palmas - Backend API Test (v0.2.0)")
    print("=" * 50)
    print("NEW: Tests StratumDefinition + BoreholeStratum structure")
    print()
    ...
    if success:
        ...
        print("4. Test the new workflow endpoints")
    else:
